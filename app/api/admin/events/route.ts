  ...
  try {
    ...
    const event = await prisma.event.create({
      data: {
        ...
        minorAuthorizationEnabled: body?.minorAuthorizationEnabled ?? false,
        minorAuthorizationText: body?.minorAuthorizationText ?? null,
        ageWarningEnabled: body?.ageWarningEnabled ?? false,
        ageWarningMessage: body?.ageWarningMessage ?? null,
        onlineSalesClosed: body?.onlineSalesClosed ?? false,
        onlineSalesClosedLabel: body?.onlineSalesClosedLabel ?? null,
        onlineSalesClosedMessage: body?.onlineSalesClosedMessage ?? null,
