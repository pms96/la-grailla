...
export function MobileBuyBar({ slug, minPrice, soldOut }: MobileBuyBarProps) {
  return (
    <div
      ...
      role="region"
      aria-label={soldOut ? 'Entradas agotadas' : 'Comprar entradas'}
    >
      <div className="max-w-[1200px] mx-auto px-4 pt-3 flex items-center gap-3">
        {soldOut ? (
          <>
            <div className="min-w-0 flex-1">
              <p className="font-display text-base font-bold leading-tight">Sin plazas online</p>
              <p className="text-xs text-muted-foreground mt-0.5">Mira otras fechas o vuelve más tarde</p>
            </div>
